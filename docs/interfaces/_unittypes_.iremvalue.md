[@johanneslumpe/css-types](../README.md) > ["unitTypes"](../modules/_unittypes_.md) > [IRemValue](../interfaces/_unittypes_.iremvalue.md)
...
* [String](_unittypes_.iremvalue.md#string)
* [__rem_brand_type__](_unittypes_.iremvalue.md#__rem_brand_type__)
* [length](_unittypes_.iremvalue.md#length)

### Methods

* [__@iterator](_unittypes_.iremvalue.md#___iterator)
* [anchor](_unittypes_.iremvalue.md#anchor)
* [big](_unittypes_.iremvalue.md#big)
* [blink](_unittypes_.iremvalue.md#blink)
* [bold](_unittypes_.iremvalue.md#bold)
* [charAt](_unittypes_.iremvalue.md#charat)
* [charCodeAt](_unittypes_.iremvalue.md#charcodeat)
* [codePointAt](_unittypes_.iremvalue.md#codepointat)
* [concat](_unittypes_.iremvalue.md#concat)
* [endsWith](_unittypes_.iremvalue.md#endswith)
* [fixed](_unittypes_.iremvalue.md#fixed)
* [fontcolor](_unittypes_.iremvalue.md#fontcolor)
* [fontsize](_unittypes_.iremvalue.md#fontsize)
* [includes](_unittypes_.iremvalue.md#includes)
* [indexOf](_unittypes_.iremvalue.md#indexof)
* [italics](_unittypes_.iremvalue.md#italics)
* [lastIndexOf](_unittypes_.iremvalue.md#lastindexof)
* [link](_unittypes_.iremvalue.md#link)
* [localeCompare](_unittypes_.iremvalue.md#localecompare)
* [match](_unittypes_.iremvalue.md#match)
* [normalize](_unittypes_.iremvalue.md#normalize)
* [padEnd](_unittypes_.iremvalue.md#padend)
* [padStart](_unittypes_.iremvalue.md#padstart)
* [repeat](_unittypes_.iremvalue.md#repeat)
* [replace](_unittypes_.iremvalue.md#replace)
* [search](_unittypes_.iremvalue.md#search)
* [slice](_unittypes_.iremvalue.md#slice)
* [small](_unittypes_.iremvalue.md#small)
* [split](_unittypes_.iremvalue.md#split)
* [startsWith](_unittypes_.iremvalue.md#startswith)
* [strike](_unittypes_.iremvalue.md#strike)
* [sub](_unittypes_.iremvalue.md#sub)
* [substr](_unittypes_.iremvalue.md#substr)
* [substring](_unittypes_.iremvalue.md#substring)
* [sup](_unittypes_.iremvalue.md#sup)
* [toLocaleLowerCase](_unittypes_.iremvalue.md#tolocalelowercase)
* [toLocaleUpperCase](_unittypes_.iremvalue.md#tolocaleuppercase)
* [toLowerCase](_unittypes_.iremvalue.md#tolowercase)
* [toString](_unittypes_.iremvalue.md#tostring)
* [toUpperCase](_unittypes_.iremvalue.md#touppercase)
* [trim](_unittypes_.iremvalue.md#trim)
* [trimLeft](_unittypes_.iremvalue.md#trimleft)
* [trimRight](_unittypes_.iremvalue.md#trimright)
* [valueOf](_unittypes_.iremvalue.md#valueof)
...
___
<a id="__rem_brand_type__"></a>

###  __rem_brand_type__

**● __rem_brand_type__**: *`never`*

*Defined in [unitTypes.ts:65](https://github.com/johanneslumpe/css-types/blob/e2805de/generated/unitTypes.ts#L65)*
