[@johanneslumpe/css-types](../README.md) > ["unitTypes"](../modules/_unittypes_.md) > [IDpcmValue](../interfaces/_unittypes_.idpcmvalue.md)

# Interface: IDpcmValue
...
* [String](_unittypes_.idpcmvalue.md#string)
* [__dpcm_brand_type__](_unittypes_.idpcmvalue.md#__dpcm_brand_type__)
* [length](_unittypes_.idpcmvalue.md#length)

### Methods

* [__@iterator](_unittypes_.idpcmvalue.md#___iterator)
* [anchor](_unittypes_.idpcmvalue.md#anchor)
* [big](_unittypes_.idpcmvalue.md#big)
* [blink](_unittypes_.idpcmvalue.md#blink)
* [bold](_unittypes_.idpcmvalue.md#bold)
* [charAt](_unittypes_.idpcmvalue.md#charat)
* [charCodeAt](_unittypes_.idpcmvalue.md#charcodeat)
* [codePointAt](_unittypes_.idpcmvalue.md#codepointat)
* [concat](_unittypes_.idpcmvalue.md#concat)
* [endsWith](_unittypes_.idpcmvalue.md#endswith)
* [fixed](_unittypes_.idpcmvalue.md#fixed)
* [fontcolor](_unittypes_.idpcmvalue.md#fontcolor)
* [fontsize](_unittypes_.idpcmvalue.md#fontsize)
* [includes](_unittypes_.idpcmvalue.md#includes)
* [indexOf](_unittypes_.idpcmvalue.md#indexof)
* [italics](_unittypes_.idpcmvalue.md#italics)
* [lastIndexOf](_unittypes_.idpcmvalue.md#lastindexof)
* [link](_unittypes_.idpcmvalue.md#link)
* [localeCompare](_unittypes_.idpcmvalue.md#localecompare)
* [match](_unittypes_.idpcmvalue.md#match)
* [normalize](_unittypes_.idpcmvalue.md#normalize)
* [padEnd](_unittypes_.idpcmvalue.md#padend)
* [padStart](_unittypes_.idpcmvalue.md#padstart)
* [repeat](_unittypes_.idpcmvalue.md#repeat)
* [replace](_unittypes_.idpcmvalue.md#replace)
* [search](_unittypes_.idpcmvalue.md#search)
* [slice](_unittypes_.idpcmvalue.md#slice)
* [small](_unittypes_.idpcmvalue.md#small)
* [split](_unittypes_.idpcmvalue.md#split)
* [startsWith](_unittypes_.idpcmvalue.md#startswith)
* [strike](_unittypes_.idpcmvalue.md#strike)
* [sub](_unittypes_.idpcmvalue.md#sub)
* [substr](_unittypes_.idpcmvalue.md#substr)
* [substring](_unittypes_.idpcmvalue.md#substring)
* [sup](_unittypes_.idpcmvalue.md#sup)
* [toLocaleLowerCase](_unittypes_.idpcmvalue.md#tolocalelowercase)
* [toLocaleUpperCase](_unittypes_.idpcmvalue.md#tolocaleuppercase)
* [toLowerCase](_unittypes_.idpcmvalue.md#tolowercase)
* [toString](_unittypes_.idpcmvalue.md#tostring)
* [toUpperCase](_unittypes_.idpcmvalue.md#touppercase)
* [trim](_unittypes_.idpcmvalue.md#trim)
* [trimLeft](_unittypes_.idpcmvalue.md#trimleft)
* [trimRight](_unittypes_.idpcmvalue.md#trimright)
* [valueOf](_unittypes_.idpcmvalue.md#valueof)
...
___
<a id="__dpcm_brand_type__"></a>

###  __dpcm_brand_type__

**● __dpcm_brand_type__**: *`never`*

*Defined in [unitTypes.ts:11](https://github.com/johanneslumpe/css-types/blob/e2805de/generated/unitTypes.ts#L11)*
