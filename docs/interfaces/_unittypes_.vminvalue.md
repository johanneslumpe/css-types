[@johanneslumpe/css-types](../README.md) > ["unitTypes"](../modules/_unittypes_.md) > [VminValue](../interfaces/_unittypes_.vminvalue.md)
...
* [String](_unittypes_.vminvalue.md#string)
* [__vmin_brand_type__](_unittypes_.vminvalue.md#__vmin_brand_type__)
* [length](_unittypes_.vminvalue.md#length)

### Methods

* [__@iterator](_unittypes_.vminvalue.md#___iterator)
* [anchor](_unittypes_.vminvalue.md#anchor)
* [big](_unittypes_.vminvalue.md#big)
* [blink](_unittypes_.vminvalue.md#blink)
* [bold](_unittypes_.vminvalue.md#bold)
* [charAt](_unittypes_.vminvalue.md#charat)
* [charCodeAt](_unittypes_.vminvalue.md#charcodeat)
* [codePointAt](_unittypes_.vminvalue.md#codepointat)
* [concat](_unittypes_.vminvalue.md#concat)
* [endsWith](_unittypes_.vminvalue.md#endswith)
* [fixed](_unittypes_.vminvalue.md#fixed)
* [fontcolor](_unittypes_.vminvalue.md#fontcolor)
* [fontsize](_unittypes_.vminvalue.md#fontsize)
* [includes](_unittypes_.vminvalue.md#includes)
* [indexOf](_unittypes_.vminvalue.md#indexof)
* [italics](_unittypes_.vminvalue.md#italics)
* [lastIndexOf](_unittypes_.vminvalue.md#lastindexof)
* [link](_unittypes_.vminvalue.md#link)
* [localeCompare](_unittypes_.vminvalue.md#localecompare)
* [match](_unittypes_.vminvalue.md#match)
* [normalize](_unittypes_.vminvalue.md#normalize)
* [padEnd](_unittypes_.vminvalue.md#padend)
* [padStart](_unittypes_.vminvalue.md#padstart)
* [repeat](_unittypes_.vminvalue.md#repeat)
* [replace](_unittypes_.vminvalue.md#replace)
* [search](_unittypes_.vminvalue.md#search)
* [slice](_unittypes_.vminvalue.md#slice)
* [small](_unittypes_.vminvalue.md#small)
* [split](_unittypes_.vminvalue.md#split)
* [startsWith](_unittypes_.vminvalue.md#startswith)
* [strike](_unittypes_.vminvalue.md#strike)
* [sub](_unittypes_.vminvalue.md#sub)
* [substr](_unittypes_.vminvalue.md#substr)
* [substring](_unittypes_.vminvalue.md#substring)
* [sup](_unittypes_.vminvalue.md#sup)
* [toLocaleLowerCase](_unittypes_.vminvalue.md#tolocalelowercase)
* [toLocaleUpperCase](_unittypes_.vminvalue.md#tolocaleuppercase)
* [toLowerCase](_unittypes_.vminvalue.md#tolowercase)
* [toString](_unittypes_.vminvalue.md#tostring)
* [toUpperCase](_unittypes_.vminvalue.md#touppercase)
* [trim](_unittypes_.vminvalue.md#trim)
* [trimLeft](_unittypes_.vminvalue.md#trimleft)
* [trimRight](_unittypes_.vminvalue.md#trimright)
* [valueOf](_unittypes_.vminvalue.md#valueof)
...
*Defined in [unitTypes.ts:80](https://github.com/johanneslumpe/css-types/blob/80e7b78/generated/unitTypes.ts#L80)*
