[@johanneslumpe/css-types](../README.md) > ["unitTypes"](../modules/_unittypes_.md) > [IDpiValue](../interfaces/_unittypes_.idpivalue.md)
...
* [String](_unittypes_.idpivalue.md#string)
* [__dpi_brand_type__](_unittypes_.idpivalue.md#__dpi_brand_type__)
* [length](_unittypes_.idpivalue.md#length)

### Methods

* [__@iterator](_unittypes_.idpivalue.md#___iterator)
* [anchor](_unittypes_.idpivalue.md#anchor)
* [big](_unittypes_.idpivalue.md#big)
* [blink](_unittypes_.idpivalue.md#blink)
* [bold](_unittypes_.idpivalue.md#bold)
* [charAt](_unittypes_.idpivalue.md#charat)
* [charCodeAt](_unittypes_.idpivalue.md#charcodeat)
* [codePointAt](_unittypes_.idpivalue.md#codepointat)
* [concat](_unittypes_.idpivalue.md#concat)
* [endsWith](_unittypes_.idpivalue.md#endswith)
* [fixed](_unittypes_.idpivalue.md#fixed)
* [fontcolor](_unittypes_.idpivalue.md#fontcolor)
* [fontsize](_unittypes_.idpivalue.md#fontsize)
* [includes](_unittypes_.idpivalue.md#includes)
* [indexOf](_unittypes_.idpivalue.md#indexof)
* [italics](_unittypes_.idpivalue.md#italics)
* [lastIndexOf](_unittypes_.idpivalue.md#lastindexof)
* [link](_unittypes_.idpivalue.md#link)
* [localeCompare](_unittypes_.idpivalue.md#localecompare)
* [match](_unittypes_.idpivalue.md#match)
* [normalize](_unittypes_.idpivalue.md#normalize)
* [padEnd](_unittypes_.idpivalue.md#padend)
* [padStart](_unittypes_.idpivalue.md#padstart)
* [repeat](_unittypes_.idpivalue.md#repeat)
* [replace](_unittypes_.idpivalue.md#replace)
* [search](_unittypes_.idpivalue.md#search)
* [slice](_unittypes_.idpivalue.md#slice)
* [small](_unittypes_.idpivalue.md#small)
* [split](_unittypes_.idpivalue.md#split)
* [startsWith](_unittypes_.idpivalue.md#startswith)
* [strike](_unittypes_.idpivalue.md#strike)
* [sub](_unittypes_.idpivalue.md#sub)
* [substr](_unittypes_.idpivalue.md#substr)
* [substring](_unittypes_.idpivalue.md#substring)
* [sup](_unittypes_.idpivalue.md#sup)
* [toLocaleLowerCase](_unittypes_.idpivalue.md#tolocalelowercase)
* [toLocaleUpperCase](_unittypes_.idpivalue.md#tolocaleuppercase)
* [toLowerCase](_unittypes_.idpivalue.md#tolowercase)
* [toString](_unittypes_.idpivalue.md#tostring)
* [toUpperCase](_unittypes_.idpivalue.md#touppercase)
* [trim](_unittypes_.idpivalue.md#trim)
* [trimLeft](_unittypes_.idpivalue.md#trimleft)
* [trimRight](_unittypes_.idpivalue.md#trimright)
* [valueOf](_unittypes_.idpivalue.md#valueof)
...
___
<a id="__dpi_brand_type__"></a>

###  __dpi_brand_type__

**● __dpi_brand_type__**: *`never`*

*Defined in [unitTypes.ts:14](https://github.com/johanneslumpe/css-types/blob/e2805de/generated/unitTypes.ts#L14)*
