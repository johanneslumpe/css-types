[@johanneslumpe/css-types](../README.md) > ["unitTypes"](../modules/_unittypes_.md) > [IInchValue](../interfaces/_unittypes_.iinchvalue.md)

# Interface: IInchValue
...
* [String](_unittypes_.iinchvalue.md#string)
* [__in_brand_type__](_unittypes_.iinchvalue.md#__in_brand_type__)
* [length](_unittypes_.iinchvalue.md#length)

### Methods

* [__@iterator](_unittypes_.iinchvalue.md#___iterator)
* [anchor](_unittypes_.iinchvalue.md#anchor)
* [big](_unittypes_.iinchvalue.md#big)
* [blink](_unittypes_.iinchvalue.md#blink)
* [bold](_unittypes_.iinchvalue.md#bold)
* [charAt](_unittypes_.iinchvalue.md#charat)
* [charCodeAt](_unittypes_.iinchvalue.md#charcodeat)
* [codePointAt](_unittypes_.iinchvalue.md#codepointat)
* [concat](_unittypes_.iinchvalue.md#concat)
* [endsWith](_unittypes_.iinchvalue.md#endswith)
* [fixed](_unittypes_.iinchvalue.md#fixed)
* [fontcolor](_unittypes_.iinchvalue.md#fontcolor)
* [fontsize](_unittypes_.iinchvalue.md#fontsize)
* [includes](_unittypes_.iinchvalue.md#includes)
* [indexOf](_unittypes_.iinchvalue.md#indexof)
* [italics](_unittypes_.iinchvalue.md#italics)
* [lastIndexOf](_unittypes_.iinchvalue.md#lastindexof)
* [link](_unittypes_.iinchvalue.md#link)
* [localeCompare](_unittypes_.iinchvalue.md#localecompare)
* [match](_unittypes_.iinchvalue.md#match)
* [normalize](_unittypes_.iinchvalue.md#normalize)
* [padEnd](_unittypes_.iinchvalue.md#padend)
* [padStart](_unittypes_.iinchvalue.md#padstart)
* [repeat](_unittypes_.iinchvalue.md#repeat)
* [replace](_unittypes_.iinchvalue.md#replace)
* [search](_unittypes_.iinchvalue.md#search)
* [slice](_unittypes_.iinchvalue.md#slice)
* [small](_unittypes_.iinchvalue.md#small)
* [split](_unittypes_.iinchvalue.md#split)
* [startsWith](_unittypes_.iinchvalue.md#startswith)
* [strike](_unittypes_.iinchvalue.md#strike)
* [sub](_unittypes_.iinchvalue.md#sub)
* [substr](_unittypes_.iinchvalue.md#substr)
* [substring](_unittypes_.iinchvalue.md#substring)
* [sup](_unittypes_.iinchvalue.md#sup)
* [toLocaleLowerCase](_unittypes_.iinchvalue.md#tolocalelowercase)
* [toLocaleUpperCase](_unittypes_.iinchvalue.md#tolocaleuppercase)
* [toLowerCase](_unittypes_.iinchvalue.md#tolowercase)
* [toString](_unittypes_.iinchvalue.md#tostring)
* [toUpperCase](_unittypes_.iinchvalue.md#touppercase)
* [trim](_unittypes_.iinchvalue.md#trim)
* [trimLeft](_unittypes_.iinchvalue.md#trimleft)
* [trimRight](_unittypes_.iinchvalue.md#trimright)
* [valueOf](_unittypes_.iinchvalue.md#valueof)
...
___
<a id="__in_brand_type__"></a>

###  __in_brand_type__

**● __in_brand_type__**: *`never`*

*Defined in [unitTypes.ts:35](https://github.com/johanneslumpe/css-types/blob/062d0fd/generated/unitTypes.ts#L35)*
