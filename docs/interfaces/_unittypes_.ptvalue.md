[@johanneslumpe/css-types](../README.md) > ["unitTypes"](../modules/_unittypes_.md) > [PtValue](../interfaces/_unittypes_.ptvalue.md)
...
* [String](_unittypes_.ptvalue.md#string)
* [__pt_brand_type__](_unittypes_.ptvalue.md#__pt_brand_type__)
* [length](_unittypes_.ptvalue.md#length)

### Methods

* [__@iterator](_unittypes_.ptvalue.md#___iterator)
* [anchor](_unittypes_.ptvalue.md#anchor)
* [big](_unittypes_.ptvalue.md#big)
* [blink](_unittypes_.ptvalue.md#blink)
* [bold](_unittypes_.ptvalue.md#bold)
* [charAt](_unittypes_.ptvalue.md#charat)
* [charCodeAt](_unittypes_.ptvalue.md#charcodeat)
* [codePointAt](_unittypes_.ptvalue.md#codepointat)
* [concat](_unittypes_.ptvalue.md#concat)
* [endsWith](_unittypes_.ptvalue.md#endswith)
* [fixed](_unittypes_.ptvalue.md#fixed)
* [fontcolor](_unittypes_.ptvalue.md#fontcolor)
* [fontsize](_unittypes_.ptvalue.md#fontsize)
* [includes](_unittypes_.ptvalue.md#includes)
* [indexOf](_unittypes_.ptvalue.md#indexof)
* [italics](_unittypes_.ptvalue.md#italics)
* [lastIndexOf](_unittypes_.ptvalue.md#lastindexof)
* [link](_unittypes_.ptvalue.md#link)
* [localeCompare](_unittypes_.ptvalue.md#localecompare)
* [match](_unittypes_.ptvalue.md#match)
* [normalize](_unittypes_.ptvalue.md#normalize)
* [padEnd](_unittypes_.ptvalue.md#padend)
* [padStart](_unittypes_.ptvalue.md#padstart)
* [repeat](_unittypes_.ptvalue.md#repeat)
* [replace](_unittypes_.ptvalue.md#replace)
* [search](_unittypes_.ptvalue.md#search)
* [slice](_unittypes_.ptvalue.md#slice)
* [small](_unittypes_.ptvalue.md#small)
* [split](_unittypes_.ptvalue.md#split)
* [startsWith](_unittypes_.ptvalue.md#startswith)
* [strike](_unittypes_.ptvalue.md#strike)
* [sub](_unittypes_.ptvalue.md#sub)
* [substr](_unittypes_.ptvalue.md#substr)
* [substring](_unittypes_.ptvalue.md#substring)
* [sup](_unittypes_.ptvalue.md#sup)
* [toLocaleLowerCase](_unittypes_.ptvalue.md#tolocalelowercase)
* [toLocaleUpperCase](_unittypes_.ptvalue.md#tolocaleuppercase)
* [toLowerCase](_unittypes_.ptvalue.md#tolowercase)
* [toString](_unittypes_.ptvalue.md#tostring)
* [toUpperCase](_unittypes_.ptvalue.md#touppercase)
* [trim](_unittypes_.ptvalue.md#trim)
* [trimLeft](_unittypes_.ptvalue.md#trimleft)
* [trimRight](_unittypes_.ptvalue.md#trimright)
* [valueOf](_unittypes_.ptvalue.md#valueof)
...
___
<a id="__pt_brand_type__"></a>

###  __pt_brand_type__

**● __pt_brand_type__**: *`never`*

*Defined in [unitTypes.ts:53](https://github.com/johanneslumpe/css-types/blob/80e7b78/generated/unitTypes.ts#L53)*
